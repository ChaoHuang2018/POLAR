...
fileID = fopen('nn_4_sigmoid.txt','w');
...
for ct = 1:(Duration/Ts)
     u = NN_output_sigmoid(x_now,0.5,6,'nn_4_sigmoid');
...
% title('Benchmark 6 (sigmoid)', 'FontSize', 14)
...
% export_fig ../Benchmarks/benchmark6_sigmoid.pdf