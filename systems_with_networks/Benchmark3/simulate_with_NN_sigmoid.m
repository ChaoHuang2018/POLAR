...
fileID = fopen('nn_3_sigmoid.txt','w');
...
for ct = 1:(Duration/Ts) 
     ...
     % u = NN_output_tanh(x_now,0,10,'nn_16_tanh');
     u = NN_output_sigmoid(x_now, 0.5, 20, 'nn_3_sigmoid');
...
% title('Benchmark 5 (sigmoid)', 'FontSize', 14)
...
% export_fig ../Benchmarks/benchmark5_sigmoid.pdf